...
est_civil varchar2(12)) tablespace users;
...
id number, 
nombre varchar2(10),
fec_inicio date) tablespace users;
...
PROMPT ====================================================================
PROMPT Creamos el CK (Ck=Check COnstraint)
--vamos a hacer una verificación de estado civil
alter table empleados add constraint emp_ck_est_civil check (est_civil in ('Casado','Soltero')); 

PROMPT =================================================================
alter table empleados add CONSTRAINT emp_salario_ck check (salario >0);
...
update departamentos set fec_inicio = sysdate;


update empleados set est_civil = 'Casado' where id = 1;
update empleados set est_civil = 'Casado' where id = 2;
