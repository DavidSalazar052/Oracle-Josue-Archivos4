...
PROMPT creamos la tabla indicando tablespace
create table empleados(id number, 
nombre varchar2(10), salario number) tablespace users;
--host pause
...
insert into empleados(id, nombre, salario) values (sec_empleados.nextval,'Lucia',1800);
commit;
