...
set CID=fceb159c6429dbf13c0ab488070395e5bc30c228ece23b7ebf29b5e7bdff5786
...
docker exec -i %CID% bash -lc "sqlplus -S system/root@localhost:1521/FREEPDB1 @%SCRIPT% %1"

REM Indica que se abrirá el archivo de salida
echo Abriendo %LOG% ...

REM Abre el archivo LOG con Notepad en instancia aparte (usando start)
